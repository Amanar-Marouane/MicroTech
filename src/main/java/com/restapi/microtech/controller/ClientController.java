...
public class ClientController {
    ...
    public ResponseEntity<LoyaltyTierResponse> getLoyaltyTier(@PathVariable Long id) {
        return ResponseEntity.ok(clientService.getLoyaltyTier(id));
    }

    @GetMapping("/{id}/stats")
    public ResponseEntity<ClientStatsResponse> getStats(@PathVariable Long id) {
        return ResponseEntity.ok(clientService.getStatistics(id));
    }

    @GetMapping("/{id}/orders")
    public ResponseEntity<List<CommandeResponse>> getOrderHistory(@PathVariable Long id) {
